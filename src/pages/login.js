        ...
        <div class="w-full space-y-0 h-screen">
            <nav class="sticky w-full h-auto bg-white px-2 sm:px-0">
                        <div class="container flex justify-between py-1 mx-auto">
                            ...
                            disabled={isInvalid}
                            type="submit" 
                            className="bg-indigo-50 font-medium mr-6 rounded-xl text-sm bg-white tracking-wider text-indigo-900 hover:bg-indigo-100 transition mt-2 py-1">
                    ...
                    <div className="container bg-gray-70 mx-auto w-full items-center h-screen"> 
                        <div className=" flex justify-center min-w-full pt-14 mx-auto px-10 md:w-4/5 md:pt-20 lg:w-4/5 lg:pt-20 ">
                            <p className="text-gray-900 text-center flex font-semibold text-5xl md:text-5x1 lg:text-5x1 flex items-center mx-auto">
                                Use Obstacles to Your Advantage
                            </p>
                        </div>
                        <div className=" flex justify-center w-4/5 pt-5 mx-auto px-10">
                            <p className="text-gray-600 text-center font-normal text-base flex items-center mx-auto">
                                Learn From Fuckups With Other Founders
                            </p>
                        </div>

                        <div className=" container flex flex-col lg:flex-row rounded-full flex  mx-auto w-full">
                                ...
                                <div class="h-40 flex items-center flex-wrap mb-0 space-x-2 ml-3 p-0 items-stretch content-start ...">
                                    <div class="w-auto h-auto">                                
                                        <div class="flex-1  h-full">
                                            <buttton 
                                                class="flex  flex-1 h-full p-2 bg-white text-yellow shadow-xl rounded-full"                                
                                                type="button"
                                                onClick={() => {
                                                    !journalModalShow
                                                    ? showJournalModal()
                            ...
                            <div class="hidden bg-white rounded-full  h-10 my-10 py-1  lg:flex flex-col lg:w-2/5 lg:mx-1 lg:px-4   ">            
                            ...
                            <div className="bg-white flex flex-col w-5/5 h-auto mx-6 my-0 px-6 py-7 md:flex md: md:w-3/5 md:h-auto md:mx-auto md:my-auto md:px-6 md:py-8 lg:flex lg:w-2/5 lg:mx-2 lg:px-4 rounded-lg shadow-2xl">
                                ...
                                <form onSubmit={handleLogin} method="POST">
                                    ...
                                    <div class="flex justify-end pb-10">
                                        <Link to={ROUTES.SIGN_UP} className="font-medium text-xs text-purple-700 hover:text-indigo-700 mb-6">
